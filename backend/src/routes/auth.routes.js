...
router.post('/match-manager/login', validate(authValidators.matchManagerLoginSchema), authController.loginMatchManager);
...
router.put('/update-profile', authenticate, validate(authValidators.updateProfileSchema), authController.updateProfile);
