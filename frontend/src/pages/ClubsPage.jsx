            ...
            <motion.div key={club._id || club.id} variants={item}>
              ...
              >
                ...
                <div className="h-40 bg-gradient-to-br from-emerald-900/40 to-teal-900/40 relative overflow-hidden">
                  {club.logoUrl || club.theme?.bannerUrl ? (
                    <img
                      src={club.theme?.bannerUrl || club.logoUrl}
                      alt={club.name}
                ...
                <div className="p-5 relative">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1 capitalize">{club.sportType || "Cricket"}</p>
                    </div>
                  ...
                  {club.activeTournaments > 0 && (
                    <div className="mt-3 flex items-center gap-2">
                      ...
                      <span className="text-xs text-emerald-400">{club.activeTournaments} active tournament{club.activeTournaments > 1 ? "s" : ""}</span>
                    </div>
                  )}
                </div>
              </Link>
